...
- [ ] **1.1 — Paste-and-scan reveals invisible characters live (WOW MOMENT)**
...
- [ ] **1.2 — Full Unicode tag-character decode to plain text**
...
- [ ] **1.3 — Zero-width & invisible character catalog completeness**
...
- [ ] **1.4 — Design polish: two-pane light-table layout**
...
- [ ] **2.1 — Bidi-override detection with reordering preview**
...
- [ ] **2.3 — Human-vs-model diff view highlights the delta**
...
- [ ] **2.4 — Design polish: interaction states & accessibility pass**
...
- [ ] **3.1 — One-click sanitize with clipboard confirmation**
...
- [ ] **3.2 — File upload / drag-and-drop for skill and MCP files**
...
- [ ] **3.3 — Shareable scan report export**
...
- [ ] **3.4 — Design polish: empty/loading/error states**
...
- [ ] **4.1 — Static build works from any subpath**
...
- [ ] **4.2 — Full test coverage across detectors and sanitize**
...
- [ ] **4.3 — Design polish: final self-review against DESIGN.md**
